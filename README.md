...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-17 07:32`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c73a0add-fa2e-4888-bbe7-3d409b394658.git
$ cd c73a0add-fa2e-4888-bbe7-3d409b394658
```
